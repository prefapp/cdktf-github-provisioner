...
*/
export declare class DependabotOrganizationSecretRepositories extends cdktf.TerraformResource {
    static readonly tfResourceType = "github_dependabot_organization_secret_repositories";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DependabotOrganizationSecretRepositoriesConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
