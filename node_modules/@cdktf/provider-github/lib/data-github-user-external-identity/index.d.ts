...
*/
export declare class DataGithubUserExternalIdentity extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_user_external_identity";
    /**
    ...
    * @param importFromId The id of the existing DataGithubUserExternalIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/5.40.0/docs/data-sources/user_external_identity#import import section} in the documentation of this resource for the id to use
    ...
    */
    constructor(scope: Construct, id: string, config: DataGithubUserExternalIdentityConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
