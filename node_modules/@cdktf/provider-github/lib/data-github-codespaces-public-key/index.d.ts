...
*/
export declare class DataGithubCodespacesPublicKey extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_codespaces_public_key";
    /**
    ...
    * @param importFromId The id of the existing DataGithubCodespacesPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/5.40.0/docs/data-sources/codespaces_public_key#import import section} in the documentation of this resource for the id to use
    ...
    */
    constructor(scope: Construct, id: string, config: DataGithubCodespacesPublicKeyConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
