...
*/
export declare class DataGithubCodespacesUserPublicKey extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_codespaces_user_public_key";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubCodespacesUserPublicKeyConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
